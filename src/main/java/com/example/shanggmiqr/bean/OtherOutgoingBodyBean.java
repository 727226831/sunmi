...
public class OtherOutgoingBodyBean {
    ...
    public OtherOutgoingBodyBean(){
        super();
    }

    public OtherOutgoingBodyBean(String vcooporderbcode_b,String materialcode,String maccode, int nnum, String uploadnum,String scannum,String uploadflag ) {
        super();
