 ...
 */
//这个文件暂时没有用，但是也不要删掉，以防登录下载需求有变
public class DataAutoDownload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper2 = new MyDataBaseHelper(DataAutoDownload.this,"ShangmiData",null,1);
        //创建或打开一个现有的数据库（数据库存在直接打开，否则创建一个新数据库）
        //创建数据库操作必须放在主线程，否则会报错
        db2 = helper2.getWritableDatabase();//获取到了 SQLiteDatabase 对象
        dialog = new ZLoadingDialog(DataAutoDownload.this);
        ...
        dataHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case 0x10:
                        Toast.makeText(DataAutoDownload.this, "请检查网络连接", Toast.LENGTH_LONG).show();
                        break;
                    case 0x11:
                        count++;
                        if (count ==6){
                        ...
                        editor1.commit();
                        Toast.makeText(DataAutoDownload.this, "仓库信息已经更新", Toast.LENGTH_LONG).show();
                        break;
                    case 0x12:
                        count++;
                        if (count ==6){
                        ...
                        editor2.commit();
                        Toast.makeText(DataAutoDownload.this, "物料信息已经更新", Toast.LENGTH_LONG).show();
                        break;
                    case 0x13:
                        count++;
                        if (count ==6){
                        ...
                        editor3.commit();
                        Toast.makeText(DataAutoDownload.this, "用户信息已经更新", Toast.LENGTH_LONG).show();
                        break;
                    case 0x14:
                        count++;
                        if (count ==6){
                        ...
                        editor4.commit();
                        Toast.makeText(DataAutoDownload.this, "客户信息已经更新", Toast.LENGTH_LONG).show();
                        break;
                    case 0x15:
                        count++;
                        if (count ==6){
                        ...
                        editor5.commit();
                        Toast.makeText(DataAutoDownload.this, "条码字典信息已经更新", Toast.LENGTH_LONG).show();
                        break;
                    case 0x16:
                        count++;
                        if (count ==6){
                        ...
                        editor6.commit();
                        Toast.makeText(DataAutoDownload.this, "供应商信息已经更新", Toast.LENGTH_LONG).show();
                        break;
                    case 0x17:
                        Toast.makeText(DataAutoDownload.this, "所有信息已经更新", Toast.LENGTH_LONG).show();
                        break;
                    case 0x18:
                        Toast.makeText(DataAutoDownload.this, "当前已经是最新数据", Toast.LENGTH_LONG).show();
                        break;
                    default:
                        break;
                }
...
//获取当前时间
    ...
    private void downloadSupplierData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                if (isNetworkConnected(DataAutoDownload.this)) {
                    try {
                            ...
                            supplier_ts_begintime = currentTs + " 00:00:01" ;
            ...
            public void run() {
                if (isNetworkConnected(DataAutoDownload.this)) {
                    try {
                            ...
                            String currentTs = Utils.getCurrentDate();
                            qrcode_rule_ts_begintime = currentTs + " 00:00:01" ;
            ...
            public void run() {
                if (isNetworkConnected(DataAutoDownload.this)) {
                    try {
                            ...
                            String currentTs = Utils.getCurrentDate();
                            customer_ts_begintime = currentTs + " 00:00:01" ;
            ...
            public void run() {
                if (isNetworkConnected(DataAutoDownload.this)) {
                    try {
                            ...
                            String currentTs = Utils.getCurrentDate();
                            user_ts_begintime = currentTs + " 00:00:01" ;
            ...
            public void run() {
                if (isNetworkConnected(DataAutoDownload.this)) {
                    try {
                            ...
                            String currentTs = Utils.getCurrentDate();
                            material_ts_begintime = currentTs + " 00:00:01" ;
            ...
            public void run() {
                if (isNetworkConnected(DataAutoDownload.this)) {
                    try {
                            ...
                            String currentTs = Utils.getCurrentDate();
                            warhouse_ts_begintime = currentTs + " 00:00:01" ;
