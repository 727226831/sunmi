...
public class LoanScannerAdapter extends BaseAdapter{

    private List<SaleDeliveryScanResultBean> mContentList;
    private LayoutInflater inflater;
    private ScannerClickListener mListener;

    public LoanScannerAdapter(Context context, List<SaleDeliveryScanResultBean> list, ScannerClickListener listener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_loan_qr_scanner, null);
            viewHolder.matrcode = (TextView) convertView.findViewById(R.id.loan_scanner_matrcode);
            viewHolder.num = (TextView) convertView.findViewById(R.id.loan_scanner_num);
            viewHolder.boxcode = (TextView) convertView.findViewById(R.id.loan_scanner_boxcode);
            viewHolder.platecode = (TextView)convertView.findViewById(R.id.loan_scanner_platecode);
            viewHolder.prodcutcode = (TextView) convertView.findViewById(R.id.loan_scanner_productcode);
            viewHolder.itemuploadflag = (TextView) convertView.findViewById(R.id.loan_scanner_itemuploadflag);
            viewHolder.delBtn = (Button)convertView.findViewById(R.id.loan_scanner_delbutton);
