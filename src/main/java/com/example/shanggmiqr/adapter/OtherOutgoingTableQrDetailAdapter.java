...
public class OtherOutgoingTableQrDetailAdapter extends BaseAdapter{

    private List<OtherOutgoingQrDetailBean> mContentList;
    private LayoutInflater inflater;
    private MyClickListener mListener;

    public OtherOutgoingTableQrDetailAdapter(Context context, List<OtherOutgoingQrDetailBean> list, MyClickListener listener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_otheroutgoing_qrdetail, null);
            viewHolder.platecode = (TextView) convertView.findViewById(R.id.platecode_otheroutgoing_qrdetail);
            viewHolder.boxcode = (TextView) convertView.findViewById(R.id.boxcode_otheroutgoing_qrdetail);
            viewHolder.prodcutcode = (TextView) convertView.findViewById(R.id.productcode_otheroutgoing_qrdetail);
            viewHolder.uploagflag = (TextView) convertView.findViewById(R.id.uploadflag_otheroutgoing_qrdetail);
            viewHolder.delBtn = (Button)convertView.findViewById(R.id.del_otheroutgoing_qrdetail);
