...
public class OtherEntryBodyTableAdapter extends BaseAdapter{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_detail_otherentry, null);
            ...
            viewHolder.radioButton = (RadioButton) convertView.findViewById(R.id.radio_otherentry);
