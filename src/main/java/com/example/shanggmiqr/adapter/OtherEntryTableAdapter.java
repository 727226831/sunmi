...
public class OtherEntryTableAdapter extends BaseAdapter{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_otherentry, null);
            viewHolder.pobillcode = (TextView) convertView.findViewById(R.id.text_id_otherentry);
            viewHolder.cwarecode = (TextView) convertView.findViewById(R.id.text_goods_name_otherentry);
            viewHolder.cwarename = (TextView) convertView.findViewById(R.id.text_codeBar_otherentry);
            viewHolder.dbilldate = (TextView) convertView.findViewById(R.id.text_dbilldate_otherentry);
            viewHolder.dr = (TextView) convertView.findViewById(R.id.text_dr_otherentry);
            viewHolder.viewBtn = (Button)convertView.findViewById(R.id.text_detail_otherentry);
            viewHolder.radioButton = (RadioButton) convertView.findViewById(R.id.radiobutton_upload_otherentry);
     ...
     //   viewHolder.viewBtn.setBackgroundColor(Color.parseColor("#B4B3B3"));
        ...
        viewHolder.radioButton.setChecked(otherEntryBean.isSelected());
