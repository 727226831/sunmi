...
public class PurchaseArrivalAdapter extends BaseAdapter{

    private List<PurchaseArrivalBean> mContentList;
    private LayoutInflater inflater;
    private MyClickListener mListener;
    private PurchaseArrivalBean saleDeliveryBean;

    public PurchaseArrivalAdapter(Context context, List<PurchaseArrivalBean> list, MyClickListener listener) {
        this.mContentList = list;
        inflater = LayoutInflater.from(context);
        mListener = listener;
    }
    public void setList(List<PurchaseArrivalBean> saleDeliveryDataBean) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        PurchaseArrivalBean goods = (PurchaseArrivalBean) this.getItem(position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_purchase_arrival, null);

            viewHolder.vbillcode = (TextView) convertView.findViewById(R.id.vbillcode_purchase_arrival);
            viewHolder.dbilldate = (TextView) convertView.findViewById(R.id.dbilldate_purchase_arrival);
            viewHolder.dr = (TextView) convertView.findViewById(R.id.dr_purchase_arrival);
            viewHolder.viewBtn = (Button)convertView.findViewById(R.id.text_detail_purchase_arrival);
            viewHolder.radioButton = (RadioButton) convertView.findViewById(R.id.radiobutton_upload_purchase_arrival);
        ...
        saleDeliveryBean = (PurchaseArrivalBean) getItem(position);
