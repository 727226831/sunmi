...
public class OtherEntryScannerAdapter extends BaseAdapter{

    private List<OtherEntryScanResultBean> mContentList;
    private LayoutInflater inflater;
    private ScannerClickListener21 mListener;

    public OtherEntryScannerAdapter(Context context, List<OtherEntryScanResultBean> list, ScannerClickListener21 listener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        OtherEntryScanResultBean goods = (OtherEntryScanResultBean) this.getItem(position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_otherentry_qr_scanner, null);
            viewHolder.itemuploadflag = (TextView) convertView.findViewById(R.id.otherentry_scanner_itemuploadflag);
            viewHolder.boxcode = (TextView) convertView.findViewById(R.id.otherentry_scanner_boxcode);
            viewHolder.platecode = (TextView)convertView.findViewById(R.id.otherentry_scanner_platecode);
            viewHolder.prodcutcode = (TextView) convertView.findViewById(R.id.otherentry_scanner_productcode);
            viewHolder.delBtn = (Button)convertView.findViewById(R.id.otherentry_scanner_delbutton);
