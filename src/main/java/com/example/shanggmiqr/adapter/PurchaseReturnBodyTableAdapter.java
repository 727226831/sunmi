...
public class PurchaseReturnBodyTableAdapter extends BaseAdapter{

    private List<PurchaseReturnBodyBean> mContentList;
    private PurchaseReturnBodyBean saleDeliveryBodyBean;
    private LayoutInflater inflater;
    private MyClickListener2 mListener;
    private int temp = -1;//记录每次点击的按钮的Id

    public PurchaseReturnBodyTableAdapter(Context context, List<PurchaseReturnBodyBean> list, MyClickListener2 listener) {
        this.mContentList = list;
        inflater = LayoutInflater.from(context);
        mListener = listener;
    }
    public void setList(List<PurchaseReturnBodyBean> saleDeliveryBodyBean) {
...
//    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        PurchaseReturnBodyBean goods = (PurchaseReturnBodyBean) this.getItem(position);
...
//        viewHolder.vcooporderbcode_b.setText(goods.getVcooporderbcode_b());
        ...
        viewHolder.matrcode.setText(goods.getMaterialcode());
        viewHolder.matrcode.setTextSize(10);
        viewHolder.matrname.setText(goods.getMaterialname());
